...
class Solution {
    ...
    public static void main(String[] args) {
        try (
                BufferedReader reader = new BufferedReader(new FileReader("/home/samza/workspace/flink-related/flink-testbed-nexmark/nexmark_scripts/draw/logs/" + args[0] + "/flink-samza-standalonesession-0-giraffe-sane.log"));
        ) {
            String str = null;
            ...
            long sumredistributeTime = 0l;
            long sumsnapshotTime = 0l;
            int nmigration = 0;
            ...
            while ((str = reader.readLine()) != null) {
                ...
                if (str.contains("Make rescalepoint with checkpointId")) {
                    ...
                    if (start != null) {
                        ...
                        nmigration++;
                        sumsnapshotTime += receiveSnapshot.getTime() - start.getTime();
                    }
                    ...
                    if (receiveSnapshot != null) {
                        ...
                        sumredistributeTime += end.getTime() - receiveSnapshot.getTime();
                    }
                }
            }
            ...
            System.out.println("avg snapshot time: " + sumsnapshotTime/nmigration);
            System.out.println("avg redistribute time: " + sumredistributeTime/nmigration);
